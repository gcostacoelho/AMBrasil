...
def initDB():
    ...
    #-----------Denúnica, Local e Campanhas (Funcionalidades)-----------#
    conecta.execute( 
    ...
    conecta.execute(
        "CREATE TABLE IF NOT EXISTS tipoLocal (id integer primary key AUTOINCREMENT, siglaEstado TEXT NOT NULL, cidade TEXT NOT NULL, logradouro TEXT NOT NULL, cep TEXT NOT NULL, denuncia INTEGER NOT NULL, foreign key(denuncia) references denuncia(id));"        
    )
    conecta.execute( 
